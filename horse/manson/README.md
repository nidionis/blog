# [Moteur Manson](https://moteurstirling.com/mace/manson/principes.php),   
...
Une esperence de 15% de rendement avec quelques [optimisations](optimisation.md)  
Et de 5% de rendement pour des conditions moins bonnes.  
Pour un moteur de [diametre](sizing_diameter.md) ~155 cm et de [volume](sizing_volume.md) ~170 L.
